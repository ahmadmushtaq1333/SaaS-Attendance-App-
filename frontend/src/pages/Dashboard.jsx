      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 20 }} className="dash-grid">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <DefaultersSection
            ...
            sendWarningNotice={sendWarningNotice}
            notifiedStudents={notifiedStudents}
          />

          {/* Feature 4: Recent Session History */}
          <SessionHistorySection recentSessions={recentSessions} />
        </div>
      </div>
...
const CoursesListSection = React.memo(({ courses, durationMinutes, setDurationMinutes, onViewReports, createSession, loading }) => {
  return (
    <details className="acc-panel" open>
      <summary>
...
const DefaultersSection = React.memo(({ allDefaulters, sendWarningNotice, notifiedStudents }) => {
  return (
    <details className="acc-panel" open>
      <summary>
...
const SessionHistorySection = React.memo(({ recentSessions }) => {
  return (
    <details className="acc-panel" open>
      <summary>
